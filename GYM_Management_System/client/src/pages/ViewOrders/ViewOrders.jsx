...
function ViewOrders() {
  ...
  const fetchPackages = async () => {
    try {
      const response = await axios.get('http://localhost:3000/userPkg');
  ...
  const deletePackage = async (id) => {
    try {
      await axios.delete(`http://localhost:3000/userPkg/delete/${id}`);
  ...
  return (
    <div style={{ backgroundImage:"url('Images/dfdfdf.jpg')",backgroundSize: "cover" ,minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      <div style={{ padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        <h2 style={{ textAlign: "center", margin: "20px 0" , color: "white", fontSize:"25px"}}>Order List</h2>
